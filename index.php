...
<head>
    ...
    <title>
        ...
        <?php require "admin/dbh.php";
        $query = "SELECT * FROM blog_posts";
        $result = mysqli_query($conn, $query);
        echo mysqli_num_rows($result); //Should Get Zero becaouse there aint any BLog post yet.
        ?>
    ...
    <section id="hero" class="s-hero">
        ...
        <div class="s-hero__social hide-on-mobile-small">
            ...
            <ul class="s-hero__social-icons">
                <li><a href="twitter.com"><i class="fab fa-facebook-f" aria-hidden="true"></i></a></li>
                <li><a href="facebook.com"><i class="fab fa-twitter" aria-hidden="true"></i></a></li>
                <li><a href="instagram.com"><i class="fab fa-instagram" aria-hidden="true"></i></a></li>
